...
from conectividade.aplicacao.portas import (
    ConsultorEscolaPortal,
    NotificadorProgressoLote,
    RepositorioIneps,
    RepositorioResultadosLote,
)
from conectividade.dominio.plano_execucao import PlanoExecucaoLote
from conectividade.dominio.resultado_consulta import ResultadoConsultaLote, StatusConsultaLote
from conectividade.dominio.resumo_lote import ResumoLote
