...
from conectividade.lote.aplicacao.portas import RepositorioIneps
...
from conectividade.lote.infraestrutura.particionamento import RepositorioIneposParticionado
...
def main(argv: list[str] | None = None) -> None:
    ...
    with Browser(url_portal=config.URL_PORTAL, headless=False, user_data_dir=perfil_chrome) as browser:
        print("\nChrome aberto.")
