...
Diferente de uma entidade de domínio totalmente tipada (com parsing de
texto para tipos nativos), os campos aqui são mantidos como texto cru (já sem o wrapper HTML do Shiny) — é exatamente o que o
